...
//     // This is a placeholder - in a real app, you'd implement the delete functionality
//     if (window.confirm("Are you sure you want to delete this user? This action cannot be undone.")) {
//       alert("User deletion would happen here in a real application");
//     }
//   };
...
//             <p className="error-message">We couldn't retrieve the user information you requested. Please try again later.</p>
//             <button 
...
//                                 {activity.type === 'booking' ? 'Room Booking' : 
//                                  activity.type === 'cancellation' ? 'Booking Cancellation' : 
//                                  'Profile Update'}
//                               </h4>
...
//                       <button className="action-button warning-button">
//                         Lock Account
//                       </button>
//                     </div>
