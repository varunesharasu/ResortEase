...
// import './Home.css';
// import RecipeChatbot from './RecipeChatbot'; // Add this import
// // import Gallery from "./Gallery"; // ✅ Correct if Gallery.js is inside `components`

// const Home = () => {
//   const [currentSlide, setCurrentSlide] = useState(0);
//   // Removed unused isMapLoaded state to resolve the error
...
//   // Removed the useEffect related to isMapLoaded as it was unused
...
//             {/* Replace the map container with the iframe */}
//             <div className="map-container">
//               <iframe
//                 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3910.2714226562816!2d77.51667267374411!3d11.460324288733103!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba93fb37c1c7097%3A0x7acf44fa3ecbe7ec!2sRoyal%20Castle%20Farm%20Stay%20Resort!5e0!3m2!1sen!2sin!4v1742619419910!5m2!1sen!2sin"
//                 width="100%"
//                 height="450"
//                 style={{ border: 0 }}
//                 allowFullScreen=""
        ...
        <div className="container">
          ...
          <div className="sustainability-content">
            <div className="sustainability-images">
              <div className="image-grid">
                <img src="https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/room-imgs/202304162346035007-6981440-f095a7fae03411edbaad0a58a9feac02.jpg" alt="Organic Garden" />
                <img src="https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/room-imgs/202304162346035007-3712-7c6d8866e03911ed95310a58a9feac02.jpg" alt="Water Conservation" />
                <img src="https://r1imghtlak.mmtcdn.com/1281c246dff811eda0030a58a9feac02.jpg" alt="Local Artisans" />
              </div>
            </div>
